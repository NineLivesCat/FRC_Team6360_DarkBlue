...
public class Drivetrain_ArcadeDrive extends Command {
	...
	protected void execute() {
		if(Robot.oi.getRightJoy().getRawButton(1)) {
		Robot.drivetrain.setArcadeDrive(-Robot.oi.getRightY()*threshold,Robot.oi. getRightX()*threshold);
		}else {
			Robot.drivetrain.setArcadeDrive(-Robot.oi.getRightY(),Robot.oi. getRightX());
		}
	}
